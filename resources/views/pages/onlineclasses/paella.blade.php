...
<div class="section-banner">
	<div class="d-block d-md-none">
		<img class="img-fluid lazyload" data-src="/images/online-paella-banner-sm.jpg" alt="online cooking class from madrid">
	</div>
	<div class="d-none d-md-block">
		<img class="img-fluid lazyload" data-src="/images/online-paella-banner.jpg" alt="online cooking class from madrid">
	</div>
</div>
@stop
@section('content')
...
<div class="row justify-content-right">
	<div class="col-12">
		...
		<div class="d-none d-md-block">
			<div class="book-now-right all-clickable"><a href="/booking?onlineclass&class=ONLINE-EVENING-PAELLA">Book Now</a></div>
		</div>
		...
		<div class="d-none d-md-block">
			<div class="row justify-content-center">
				<div class="col-md-6">
					<p></p>
					<div class="xxl-button all-clickable"><a href="/booking?onlineclass&class=ONLINE-EVENING-PAELLA">Book Now</a></div>
					<p></p>
				</div>
			</div>
		</div>
